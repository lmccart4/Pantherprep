...
export function BattleStatsVisual() {
  const stats = [
    { n: "25", label: "battle questions", sub: "All Craft & Structure skills" },
    { n: "~28%", label: "of SAT R&W", sub: "Craft & Structure coverage" },
    { n: "4", label: "skill types", sub: "Vocab, purpose, function, cross-text" },
  ];
