...
export function BattleStatsVisual() {
  const stats = [
    { n: "25", label: "battle questions", sub: "All conventions skills" },
    { n: "~26%", label: "of SAT R&W", sub: "Conventions coverage" },
    { n: "5", label: "skill types", sub: "Boundary, SVA, modifier, parallel, tense" },
  ];
