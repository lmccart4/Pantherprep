...
export const SKILL_MAP: Record<string, SkillMapping> = {
  ...
  // ==== MATH — Advanced Math ====
  "Completing the square":                          { taxonomyKey: "completing_the_square", domain: "Advanced Math" },
  "Complex numbers":                                { taxonomyKey: "quadratic_equations",   domain: "Advanced Math" },
  "Composition of functions":                       { taxonomyKey: "function_notation",     domain: "Advanced Math" },
  "Equivalent expressions":                         { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Equivalent expressions (FOIL)":                  { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Equivalent expressions (factoring)":             { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Equivalent forms of quadratics":                 { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  ...
  "Function evaluation":                            { taxonomyKey: "function_notation",     domain: "Advanced Math" },
  "Function notation":                              { taxonomyKey: "function_notation",     domain: "Advanced Math" },
  "Polynomial evaluation":                          { taxonomyKey: "function_notation",     domain: "Advanced Math" },
  "Polynomial factoring":                           { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  ...
  "Quadratic equations (factoring)":                { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Quadratic expressions (FOIL)":                   { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Quadratic functions (vertex form)":              { taxonomyKey: "completing_the_square", domain: "Advanced Math" },
  "Quadratic functions (vertex)":                   { taxonomyKey: "completing_the_square", domain: "Advanced Math" },
  ...
  "Vertex form of quadratics":                      { taxonomyKey: "completing_the_square", domain: "Advanced Math" },

  // ==== MATH — Problem Solving & Data ====
  "Confidence intervals / margin of error":         { taxonomyKey: "margin_of_error",          domain: "Problem Solving & Data" },
  "Data interpretation":                            { taxonomyKey: "scatterplots",             domain: "Problem Solving & Data" },
  "Margin of error / confidence intervals":         { taxonomyKey: "margin_of_error",          domain: "Problem Solving & Data" },
  ...
  "Study design":                                   { taxonomyKey: "evaluating_statistical_claims", domain: "Problem Solving & Data" },
  "Observational vs experimental":                  { taxonomyKey: "evaluating_statistical_claims", domain: "Problem Solving & Data" },
  "Evaluating statistical claims":                  { taxonomyKey: "evaluating_statistical_claims", domain: "Problem Solving & Data" },
  ...
  "Circle equations":                               { taxonomyKey: "circle_equations_xy", domain: "Geometry & Trig" },
  "Circles in the coordinate plane":                { taxonomyKey: "circle_equations_xy", domain: "Geometry & Trig" },
  ...
  // Advanced Math
  "Difference of squares":       { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  ...
  "FOIL":                        { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "FOIL with negatives":         { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Factoring":                   { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Factoring quadratics":        { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  "Function composition":        { taxonomyKey: "function_notation",      domain: "Advanced Math" },
  "Function operations":         { taxonomyKey: "function_notation",      domain: "Advanced Math" },
  "Function transformations":    { taxonomyKey: "function_notation",      domain: "Advanced Math" },
  ...
  "Quadratic factoring":         { taxonomyKey: "equivalent_expressions", domain: "Advanced Math" },
  ...
  "Vertex form":                 { taxonomyKey: "completing_the_square", domain: "Advanced Math" },

  // Problem Solving & Data
  "Line of best fit":            { taxonomyKey: "linear_regression",        domain: "Problem Solving & Data" },
  "Margin of error":             { taxonomyKey: "margin_of_error",          domain: "Problem Solving & Data" },
